...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write("       rsync -avz media/ lightofl@<server>:/home/lightofl/haske_live/media/")
        self.stdout.write("  2. Upload seed.json to the server:")
        self.stdout.write("       scp core/fixtures/seed.json lightofl@<server>:/home/lightofl/haske_live/core/fixtures/")
